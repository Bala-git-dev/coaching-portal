...
import "C:/Users/bkumar/ceg-home/src/App.css";
...
const useStyles = makeStyles((theme) => ({
    ...
    const Coaching_feedback_form = () => {
        ...
        /* const submitParam = {
            teamName: team_val_sel.length > 0 ? team_val_sel[0] : '',
            agentName: agent_name.length > 0 ? agent_name[0] : '',
            agenda: session_agenda,
            followUp: followup,
            followUpFlag: followup_radio,
            focusArea1: focusarea,
            rootCause1: rootcause,
